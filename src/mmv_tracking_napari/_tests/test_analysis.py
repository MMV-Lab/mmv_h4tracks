...
@pytest.mark.parametrize(
    ...
    [("false positive.tif", 2), ("false positive_1.tif", 3)],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("false_negative.tif", 1, "GT.tif"),
        ("false_negative_1.tif", 5, "GT.tif"),
        ("false_negative_2.tif", 2, "GT_false_negative_2.tif"),
    ],
)
...
@pytest.mark.eval_tracking
@pytest.mark.unit
@pytest.mark.parametrize("layername, expected_value", [("falsely_merged.tif", 3)])
...
@pytest.mark.parametrize(
    ...
    [("false positive.tif", "added_edge.npy", 7)],
)
