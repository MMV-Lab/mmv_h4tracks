...
class CallbackHandler:
    ...
    def print_callbacks(self, layer):
    ...
    def _remove_callback(self, layer):
    ...
    def _add_callback(self, layer, callback):
    ...
    def add_callback_viewer(self, callback):
